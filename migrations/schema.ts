import { pgTable, uuid, timestamp, text, foreignKey, jsonb, boolean, check, bigint, integer, pgEnum } from "drizzle-orm/pg-core"
...
export const subscriptions = pgTable("subscriptions", {
	...
	created: timestamp({ withTimezone: true, mode: 'string' }).default(timezone('utc'::text, now())).notNull(),
